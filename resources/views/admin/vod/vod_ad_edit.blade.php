        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>视频广告管理 <small>视频广告编辑</small></h5>
                </div>
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-12">
                            <form role="form" method="post" id="myForm">
                                <input type="hidden" value="{{$vod_ad->id}}" name="id">
                                <div class="form-group">
                                    <label>名称</label>
                                    <input type="text" name="name" placeholder="名称" class="form-control" style="width: 40%;" required aria-required="true" value="{{$vod_ad->name}}">
                                </div>
                                <div class="form-group">
                                    <label>描述</label>
                                    <input type="text" name="desc" placeholder="描述" class="form-control" style="width: 40%;" required aria-required="true" value="{{$vod_ad->desc}}">
                                </div>
                                <style>
                                ...
                                <div class="form-group">
									...
									<input type="hidden" name="url" value="{{$vod_ad->url}}" id="url"/>
                                </div>
                                <div>
...
<script>
    function save() {
        ...
        $.ajax({
            ...
            url:"{{route('admin.vod.vod_ad_edit')}}",
            type:'post',
            data:formData,
            timeout:0,
            datatype:'text',
