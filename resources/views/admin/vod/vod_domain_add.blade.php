        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>视频资源域名管理 <small>视频资源域名添加</small></h5>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <form role="form" method="post" id="myForm">
                                ...
                                <div class="form-group">
                                    <label>URL</label>
                                    <input type="text" name="domain" placeholder="URL" class="form-control" style="width: 40%;" required aria-required="true">
                                </div>
                                <div>
...
<script>
    function save() {
        ...
        $.ajax({
            ...
            url:"{{route('admin.vod.vod_domain_add')}}",
            type:'post',
            data:formData,
            timeout:0,
            datatype:'text',
