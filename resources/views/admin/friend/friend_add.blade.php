        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>友情链接管理 <small>友情链接添加</small></h5>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <form role="form" method="post" id="myForm">
                                ...
                                <div class="form-group">
                                    <label>链接</label>
                                    <input type="text" name="url" placeholder="链接" class="form-control" style="width: 40%;" required aria-required="true">
                                </div>
                                <div class="form-group">
                                    <label>排序</label>
...
<script>
    function save() {
        ...
        $.ajax({
            ...
            url:"{{route('admin.friend.friend_add')}}",
            type:'post',
            data:formData,
            timeout:0,
            datatype:'text',
